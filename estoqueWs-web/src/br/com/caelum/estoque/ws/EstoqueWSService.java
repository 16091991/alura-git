 ...
 * 2020-08-25T22:06:17.190-03:00
 * Generated source version: 3.3.6
 *
 */
@WebServiceClient(name = "EstoqueWSService",
                  wsdlLocation = "file:/home/curso/eclipse-workspace/estoqueWs-web/src/EstoqueWSServiceCap5.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/curso/eclipse-workspace/estoqueWs-web/src/EstoqueWSServiceCap5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/curso/eclipse-workspace/estoqueWs-web/src/EstoqueWSServiceCap5.wsdl");
        }
        WSDL_LOCATION = url;
    }
